        ...
        if(!$wtgcsv_is_installed){
            ...
            <div class="<?php echo WTG_CSV_ABB;?>boxcontent_div">
                ...
                if($wtgcsv_apiservicestatus){
                    echo '<img src="'.WTG_CSV_IMAGEFOLDER_URL.'banners/webtechglobal-webservice-online.png"/>';                        
                }else{
                    echo '<img src="'.WTG_CSV_IMAGEFOLDER_URL.'banners/webtechglobal-webservice-maintenence.png"/>'; 
                }
                ...
                ####                                   ####
                ###########################################             
                if(isset($wtgcsv_is_subscribed) && $wtgcsv_is_subscribed == true){
                    echo '<img src="'.WTG_CSV_IMAGEFOLDER_URL.'banners/webtechglobal-wpsubscription-active.png"/>';    
                }elseif(isset($wtgcsv_is_subscribed) && $wtgcsv_is_subscribed == false){ 
                    echo '<img src="'.WTG_CSV_IMAGEFOLDER_URL.'banners/webtechglobal-wpsubscription-none.png"/>';         
                }else{
                    echo '<img src="'.WTG_CSV_IMAGEFOLDER_URL.'banners/webtechglobal-wpsubscription-unknown.png"/>';          
                }?>

...
$panel_array['panel_intro'] = __('You need to activate a project to make changes to its settings');
...
<?php wtgcsv_panel_header( $panel_array );?>
    ...
    <p>Enter Project Name: <input type='text' name='wtgcsv_projectname_name' id='<?php echo $projectname_id;?>' value='' /><span id="wtgcsv_status_<?php echo $jsform_set['form_id'];?>"></span></p>
    ...
    <h4>Select Table Mapping Type</h4>
    <script>
    $(function() {
    ...
    <div id="wtgcsv_projecttableselection_mapping_option">
        ...
        <input type="radio" id="wtgcsv_projecttables_mappingmethod_defaultorder" name="wtgcsv_projecttables_mappingmethod_inputname" value="defaultorder" <?php echo $checked_defaultorder;?> /><label for="wtgcsv_projecttables_mappingmethod_defaultorder">Default Order</label>
        <input type="radio" id="wtgcsv_projecttables_mappingmethod_singlekeycolumn" name="wtgcsv_projecttables_mappingmethod_inputname" value="singlekeycolumn" <?php echo $checked_singlekeycolumn;?> /><label for="wtgcsv_projecttables_mappingmethod_singlekeycolumn">Single Key Column</label>
        <input type="radio" id="wtgcsv_projecttables_mappingmethod_manykeycolumns" name="wtgcsv_projecttables_mappingmethod_inputname" value="manykeycolumns" <?php echo $checked_manykeycolumns;?> /><label for="wtgcsv_projecttables_mappingmethod_manykeycolumns">Many Key Columns</label>            
    </div>
...
$panel_array['panel_number'] = $panel_number;// number of panels counted on page, used to create object ID
$panel_array['panel_title'] = __('Delete Projects');// user seen panel header text 
$panel_array['pageid'] = $pageid;// store the $pageid for sake of ease
$panel_array['tabnumber'] = $wtgcsv_tab_number; 
$panel_array['panel_id'] = $panel_array['panel_name'].$panel_number;// creates a unique id, may change from version to version but within a version it should be unique

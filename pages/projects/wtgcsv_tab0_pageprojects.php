...
if($wtgcsv_is_free){$panel_array['panel_intro'] = __('Full edition allows multiple projects to be created, this panel is not required for the free download');}else{$panel_array['panel_intro'] = __('You can activate any project to make changes to its configuration');}

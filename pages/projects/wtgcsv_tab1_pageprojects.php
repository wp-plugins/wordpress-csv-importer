...
<?php wtgcsv_panel_header( $panel_array );?>
    ...
    <p>                    
        Design: 
        <select name="wtgcsv_dynamiccontentdesignrules_select_templateid" id="wtgcsv_dynamiccontentdesignrules_select_template_formid" style="width: 500px; display: none; ">

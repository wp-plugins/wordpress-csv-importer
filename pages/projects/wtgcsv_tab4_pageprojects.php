...
$panel_array['panel_title'] = __('Default Post Type');// user seen panel header text 
...
$panel_array['panel_number'] = $panel_number;// number of panels counted on page, used to create object ID
$panel_array['panel_title'] = __('Dynamic Post Type Rules');// user seen panel header text 
$panel_array['pageid'] = $pageid;// store the $pageid for sake of ease
$panel_array['tabnumber'] = $wtgcsv_tab_number; 
$panel_array['panel_id'] = $panel_array['panel_name'].$panel_number;// creates a unique id, may change from version to version but within a version it should be unique
...
<?php wtgcsv_panel_header( $panel_array );?>
    ...
    <p>        
        Table Column: 
        <select name="wtgcsv_dynamicposttype_select_columnandtable" id="wtgcsv_dynamicposttype_select_columnandtable_formid" style="width: 500px; display: none; ">
    ...
    <p>                    
        Post Type: 
        <select name="wtgcsv_dynamicposttype_select_posttype" id="wtgcsv_dynamicposttype_select_posttype_formid">

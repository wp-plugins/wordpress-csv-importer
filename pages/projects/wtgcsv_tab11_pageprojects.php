...
$panel_array['panel_title'] = __('Tag Rules');// user seen panel header text 
...
<?php wtgcsv_panel_header( $panel_array );?>
    ...
    <table class="widefat post fixed">
        ...
        <tr>
            <td><input type="checkbox" id="check1test1" class="exclusioncheckboxes" /><label for="check1test1">Delete</label></td>                                            
            <td>2011</td>                                                                                                               
        </tr> 
        <tr>
            <td><input type="checkbox" id="check1test2" class="exclusioncheckboxes" /><label for="check1test2">Delete</label></td>                        
            <td>profanity</td>                                                                                                               
        </tr>
        <tr>
            <td><input type="checkbox" id="check1test3" class="exclusioncheckboxes" /><label for="check1test3">Delete</label></td>                        
            <td>http</td>                                                                                                               
        </tr>                                                                                                              
    </table>

...
<?php wtgcsv_panel_header( $panel_array );?>
    ...
    <p>         
        <select name="wtgcsv_defaulttagsdata_select_columnandtable" id="wtgcsv_defaulttagsdata_select_columnandtable_formid" style="width: 500px; display: none; ">

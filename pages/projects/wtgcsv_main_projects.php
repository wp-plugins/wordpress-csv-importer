<?php      
global $wtgcsv_display_testing_info,$wtgcsv_mpt_arr,$wpdb,$wtgcsv_options_array,$wtgcsv_projectslist_array,$wtgcsv_currentproject_code,$wtgcsv_nav_type,$wtgcsv_project_array,$wtgcsv_is_free;

...
<?php wtgcsv_panel_header( $panel_array );?>
    ...
    <select name="wtgcsv_categorylevel1_select_columnandtable" id="wtgcsv_categorylevel1_select_columnandtable_objectid" style="width: 500px; display: none; ">
        ...
        <?php 
        if(isset($wtgcsv_project_array['categories']['standard']['level1']['table']) && isset($wtgcsv_project_array['categories']['standard']['level1']['column'])){
            wtgcsv_display_project_columnsandtables_menuoptions($wtgcsv_currentproject_code,$wtgcsv_project_array['categories']['standard']['level1']['table'],$wtgcsv_project_array['categories']['standard']['level1']['column']);    
        }else{
    ...
    <select name="wtgcsv_categorylevel2_select_columnandtable" id="wtgcsv_categorylevel2_select_columnandtable_objectid" style="width: 500px; display: none; ">
        ...
        <?php 
        if(isset($wtgcsv_project_array['categories']['standard']['level2']['table']) && isset($wtgcsv_project_array['categories']['standard']['level2']['column'])){
            wtgcsv_display_project_columnsandtables_menuoptions($wtgcsv_currentproject_code,$wtgcsv_project_array['categories']['standard']['level2']['table'],$wtgcsv_project_array['categories']['standard']['level2']['column']);    
        }else{
            wtgcsv_display_project_columnsandtables_menuoptions($wtgcsv_currentproject_code);            
        }
        ?>                                                                                                                     
    ...
    <select name="wtgcsv_categorylevel3_select_columnandtable" id="wtgcsv_categorylevel3_select_columnandtable_objectid" style="width: 500px; display: none; ">
        ...
        <?php 
        if(isset($wtgcsv_project_array['categories']['standard']['level3']['table']) && isset($wtgcsv_project_array['categories']['standard']['level3']['column'])){
            wtgcsv_display_project_columnsandtables_menuoptions($wtgcsv_currentproject_code,$wtgcsv_project_array['categories']['standard']['level3']['table'],$wtgcsv_project_array['categories']['standard']['level3']['column']);    
        }else{
            wtgcsv_display_project_columnsandtables_menuoptions($wtgcsv_currentproject_code);            
        }
        ?>                                                                                                                     
    ...
    <select name="wtgcsv_categorylevel4_select_columnandtable" id="wtgcsv_categorylevel4_select_columnandtable_objectid" style="width: 500px; display: none; ">
        ...
        <?php 
        if(isset($wtgcsv_project_array['categories']['standard']['level4']['table']) && isset($wtgcsv_project_array['categories']['standard']['level4']['column'])){
            wtgcsv_display_project_columnsandtables_menuoptions($wtgcsv_currentproject_code,$wtgcsv_project_array['categories']['standard']['level4']['table'],$wtgcsv_project_array['categories']['standard']['level4']['column']);    
        }else{
            wtgcsv_display_project_columnsandtables_menuoptions($wtgcsv_currentproject_code);            
        }
        ?>                                                                                                                     
    ...
    <select name="wtgcsv_categorylevel5_select_columnandtable" id="wtgcsv_categorylevel5_select_columnandtable_objectid" style="width: 500px; display: none; ">
        ...
        <?php 
        if(isset($wtgcsv_project_array['categories']['standard']['level5']['table']) && isset($wtgcsv_project_array['categories']['standard']['level5']['column'])){
            wtgcsv_display_project_columnsandtables_menuoptions($wtgcsv_currentproject_code,$wtgcsv_project_array['categories']['standard']['level5']['table'],$wtgcsv_project_array['categories']['standard']['level5']['column']);    
        }else{
            wtgcsv_display_project_columnsandtables_menuoptions($wtgcsv_currentproject_code);            
        }
        ?>                                                                                                                     

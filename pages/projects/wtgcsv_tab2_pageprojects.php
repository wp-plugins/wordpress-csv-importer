<?php 
if(!isset($wtgcsv_project_array['default_titletemplate_id'])){
    echo wtgcsv_notice('You have not selected a title template yet, this is a requirement for all projects.','warning','Tiny','','','return');
}else{
    echo wtgcsv_notice('Your project has a title template setup.','info','Tiny','','','return');
}
?>

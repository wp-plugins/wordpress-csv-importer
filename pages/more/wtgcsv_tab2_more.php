...
$panel_array['panel_intro'] = __('Download the latest version of '.WTG_CSV_PLUGINTITLE.', requires premium activation.');
$panel_array['panel_help'] = __('If you activate Premium Services for '.WTG_CSV_PLUGINTITLE.' you will be able to download the plugin from this panel. Do not copy the download link offered on this page, it only works once and only works within this blog. Too many attempts to use the same download URL can result in this service being automatically suspended for you account, do not share the linke online.'); 
...
$panel_array['tabnumber'] = $wtgcsv_tab_number; 
$panel_array['panel_id'] = $panel_array['panel_name'].$panel_number;// creates a unique id, may change from version to version but within a version it should be unique
$panel_array['panel_intro'] = __('Download past versions of '.WTG_CSV_PLUGINTITLE.', requires premium activation.');
$panel_array['panel_help'] = __('If you activate Premium Services for '.WTG_CSV_PLUGINTITLE.' you will be able to download previous versions of the plugin from this panel. Do not copy the download links offered on this page, they only works once and they only work within this blog. Too many attempts to use the same download URL can result in this service being automatically suspended for you account, do not share the link online.');
$panel_array['help_button'] = wtgcsv_helpbutton_text(true,false);
?>
<?php wtgcsv_panel_header( $panel_array );?>
               <p>Service not currently available</p>
...
$panel_array['tabnumber'] = $wtgcsv_tab_number; 
$panel_array['panel_id'] = $panel_array['panel_name'].$panel_number;// creates a unique id, may change from version to version but within a version it should be unique
$panel_array['panel_intro'] = __(WTG_CSV_PLUGINTITLE.' is one of many plugins I provide, download my other plugins here.');
...
$panel_array['tabnumber'] = $wtgcsv_tab_number; 
$panel_array['panel_id'] = $panel_array['panel_name'].$panel_number;// creates a unique id, may change from version to version but within a version it should be unique
$panel_array['panel_intro'] = __('Plugins that work well with '.WTG_CSV_PLUGINTITLE);
$panel_array['panel_help'] = __('Please let me know any plugins you like to use with  '.WTG_CSV_PLUGINTITLE.' and any idea you might have for integration features.');
$panel_array['help_button'] = wtgcsv_helpbutton_text(true,false);
?>
<?php wtgcsv_panel_header( $panel_array );?>

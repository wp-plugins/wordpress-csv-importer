...
<?php wtgcsv_panel_header( $panel_array );?>
    ...
    if($total_tickets == 0){
        wtgcsv_notice('You do not have any open tickets', 'info', 'Tiny', false);
    }else{?>

        <script>
        $(function() {
                $( "#<?php echo WTG_CSV_ABB;?>accordion_opentickets" ).accordion();
        });
        </script>

        <div id="<?php echo WTG_CSV_ABB;?>accordion_opentickets">
...
<?php wtgcsv_panel_header( $panel_array );?>
    ...
    if($total_tickets == 0){
        ...
        <script>
        $(function() {
                $( "#<?php echo WTG_CSV_ABB;?>accordion_closedtickets" ).accordion();
        });
        </script>

        <div id="<?php echo WTG_CSV_ABB;?>accordion_closedtickets">

...
if(isset($_POST[WTG_CSV_ABB . 'openpluginhelp'])){$contactreason = 'pluginhelp';}
elseif(isset($_POST[WTG_CSV_ABB . 'openhire'])){$contactreason = 'openhire';}            
elseif(isset($_POST[WTG_CSV_ABB . 'opentestimonial'])){$contactreason = 'testimonial';}            
elseif(isset($_POST[WTG_CSV_ABB . 'openbugreport'])){$contactreason = 'bug';}            
elseif(isset($_POST[WTG_CSV_ABB . 'opengeneraladvice'])){$contactreason = 'generaladvice';}            
elseif(isset($_POST[WTG_CSV_ABB . 'openrequestchanges'])){$contactreason = 'requestchanges';}            
elseif(isset($_POST[WTG_CSV_ABB . 'openrequestfeature'])){$contactreason = 'requestfeature';}            
elseif(isset($_POST[WTG_CSV_ABB . 'openrequesttutorial'])){$contactreason = 'requesttutorial';}            
elseif(isset($_POST[WTG_CSV_ABB . 'openaffiliateenquiry'])){$contactreason = 'affiliateenquiry';}  
elseif(isset($_POST[WTG_CSV_ABB . 'openprovideftp'])){$contactreason = 'provideftp';}  
elseif(isset($_POST[WTG_CSV_ABB . 'openprovideadmin'])){$contactreason = 'provideadmin';}  
elseif(isset($_POST[WTG_CSV_ABB . 'openprovidemysql'])){$contactreason = 'providemysql';}  
elseif(isset($_POST[WTG_CSV_ABB . 'openprovidehosting'])){$contactreason = 'providehosting';}                 
...
<div id="titles" class="postbox">
    ...
    <?php // change panel title depending on contact reason - this gets added to hidden field also as wtgcsv_contactreason_frompost
    if($contactreason == 'pluginhelp'){
        ...
        $panel_array['panel_intro'] = 'Contact the developer of '.WTG_CSV_PLUGINTITLE.' for support or general questions';
    ...
    <div class="inside" id="<?php echo $panel_array['panel_name'];?>-box-inside-icon">
        ...
        <div class="wtgcsv_boxintro_div">
            ...
            wtgcsv_helpbutton_closebox($panel_array);?>
        ...
        <div class="<?php echo WTG_CSV_ABB;?>boxcontent_div">
            ...
            // http://www.webtechglobal.co.uk/blog/wordpress/wordpresscsvimporter/wtg-pt-jquery-dialogue-form
            ...
            <input type="hidden" id="<?php echo WTG_CSV_ABB;?>contactreason_frompost" name="<?php echo WTG_CSV_ABB;?>contactreason_frompost" value="<?php echo $contactreason; ?>"> 

            <!-- CONTACT METHODS -->
            <script type="text/javascript">
            $(function(){
                $("#wtgcsv_contactmethods").multiselect({
                    selectedList: 10
                });
            });
            </script>   
            ...
            <label for="<?php echo WTG_CSV_ABB;?>contactmethods">Select Contact Methods:</label>
                <select title="Contact Methods" multiple="multiple" name="<?php echo WTG_CSV_ABB;?>contactmethods" id="<?php echo WTG_CSV_ABB;?>contactmethods" class="wtgcsv_multiselect_menu">
            ...
            <script type="text/javascript">
            $("#wtgcsv_contactmethods").multiselect().multiselectfilter();
            </script> 
            ...
            <script type="text/javascript">
            $(function(){
                $("#<?php echo WTG_CSV_ABB;?>contactreason").multiselect({
                    selectedList: 10
                });
            });
            </script>                                                                                      
                 
            <p><label for="<?php echo WTG_CSV_ABB;?>contactreason">Reason For Contact:</label>
                <select title="Contact Reason" multiple="multiple" name="<?php echo WTG_CSV_ABB;?>contactreason" id="<?php echo WTG_CSV_ABB;?>contactreason" class="wtgcsv_multiselect_menu">
            ...
            <script type="text/javascript">
            $(function(){
                $("#<?php echo WTG_CSV_ABB;?>contactinclude").multiselect({
                    selectedList: 10
                });
            });
            </script> 
             
            <p><label for="<?php echo WTG_CSV_ABB;?>contactinclude">Send Sensitive Data:</label>
                <select title="Basic example" multiple="multiple" name="<?php echo WTG_CSV_ABB;?>contactinclude" id="<?php echo WTG_CSV_ABB;?>contactinclude" class="wtgcsv_multiselect_menu">                   
            ...
            <script type="text/javascript">
            $("#<?php echo WTG_CSV_ABB;?>contactinclude").multiselect().multiselectfilter();
            </script>         
            ...
            <script type="text/javascript">
            $(function(){
                $("#<?php echo WTG_CSV_ABB;?>contactpriority").multiselect({
                    selectedList: 10
                });
            });
            </script>  
               
            <p><label for="<?php echo WTG_CSV_ABB;?>contactpriority">Priority:</label>
                <select title="Basic example" multiple="multiple" name="<?php echo WTG_CSV_ABB;?>contactpriority" id="<?php echo WTG_CSV_ABB;?>contactpriority" class="wtgcsv_multiselect_menu">
            ...
            <p>
                <textarea name="<?php echo WTG_CSV_ABB;?>contactdescription" id="<?php echo WTG_CSV_ABB;?>contactdescription" rows="10" cols="58">Please include further details here</textarea> 
            </p>
            ...
            <p><label for="<?php echo WTG_CSV_ABB;?>linkone">Link 1:</label><input type="text" name="<?php echo WTG_CSV_ABB;?>linkone" id="<?php echo WTG_CSV_ABB;?>linkone" value="" size="60" /></p>
                
            <p><label for="<?php echo WTG_CSV_ABB;?>linkone">Link 2:</label><input type="text" name="<?php echo WTG_CSV_ABB;?>linktwo" id="<?php echo WTG_CSV_ABB;?>linktwo" value="" size="60" /></p>
                            
            <p><label for="<?php echo WTG_CSV_ABB;?>linkone">Link 3:</label><input type="text" name="<?php echo WTG_CSV_ABB;?>linkthree" id="<?php echo WTG_CSV_ABB;?>linkthree" value="" size="60" /></p>                 

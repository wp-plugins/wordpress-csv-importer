...
<div id="titles" class="postbox">
    ...
    <div class="inside" id="<?php echo $panel_array['panel_name'];?>-box-inside-icon">
        ...
        <?php wtgcsv_notice_featureunderconstruction(false);?>
        ...
        <div class="<?php echo WTG_CSV_ABB;?>boxcontent_div">
            ...
            <label for="<?php echo WTG_CSV_ABB;?>contactmethods">Select Contact Methods:</label>
                <select title="Contact Methods" multiple="multiple" name="<?php echo WTG_CSV_ABB;?>contactmethods" id="<?php echo WTG_CSV_ABB;?>contactmethods" size="3">
            ...
            <p><label for="<?php echo WTG_CSV_ABB;?>contactreason">Reason For Contact:</label>
                <select title="Contact Reason" multiple="multiple" name="<?php echo WTG_CSV_ABB;?>contactreason" id="<?php echo WTG_CSV_ABB;?>contactreason" size="3">
            ...
            <p><label for="<?php echo WTG_CSV_ABB;?>contactinclude">Send Sensitive Data:</label>
                <select title="Basic example" multiple="multiple" name="<?php echo WTG_CSV_ABB;?>contactinclude" id="<?php echo WTG_CSV_ABB;?>contactinclude" size="3">                   
            ...
            <p><label for="<?php echo WTG_CSV_ABB;?>contactpriority">Priority:</label>
                <select title="Basic example" multiple="multiple" name="<?php echo WTG_CSV_ABB;?>contactpriority" id="<?php echo WTG_CSV_ABB;?>contactpriority" size="3">

...
if($wtgcsv_is_installed){
    ...
    ####                                   ####
    ###########################################
    // membership is determined by the domain being registered
    // if the domain is not registered, we cannot determin that the user is a member
    if(isset($wtgcsv_apiservicestatus) && $wtgcsv_apiservicestatus == "offline"){      
        // web services are offline...
        ### TODO:CRITICAL,change these image names and ensure they are local
        ### TODO:HIGHPRIORITY, check the server-status url and if required create page for it
        echo '<img src="'.WTG_CSV_IMAGEFOLDER_URL.'banners/webtechglobal-pluginmembership-unknown.png"/>';
        echo '<a href="http://www.wordpresscsvimporter.com/service-status" target="_blank"><img src="'.WTG_CSV_IMAGEFOLDER_URL.'banners/instructions/webtechglobal-instructions-viewservicestatus.png" /></a>';                            
    }else{
        ...
        if($wtgcsv_is_domainregistered){ 
            ...
            echo '<a href="'.$wtgcsv_homesite.'" target="_blank"><img src="'.WTG_CSV_IMAGEFOLDER_URL.'banners/instructions/webtechglobal-instructions-registerdomain.png" /></a>';                        
        }        
    }
}
?>

...
function wtgcsv_api_webservices_status_soapcall(){
    ...
    $domain_result = wtgcsv_domain_online('http://www.wordpresscsvimporter.com');
    ...
    'location' => "http://www.wordpresscsvimporter.com/wordpresswebservices/wtgapi_status.php",
    'uri'      => "http://www.wordpresscsvimporter.com/wordpresswebservices/request/"));
...
function wtgcsv_validate_call_code($callcode){
    $client = new SoapClient(null, array(
    'location' => "http://www.wordpresscsvimporter.com/wordpresswebservices/wtgapi_webservice_validatecallcode.php",
    'uri'      => "http://www.wordpresscsvimporter.com/wordpresswebservices/request/"));
...
function wtgcsv_confirm_current_domain_is_registered(){
    ...
    $client = new SoapClient(null, array(
    'location' => "http://www.wordpresscsvimporter.com/wordpresswebservices/wtgapi_webservice_checkdomainisregistered.php",
    'uri'      => "http://www.wordpresscsvimporter.com/wordpresswebservices/request/"));
...
function wtgcsv_api_checksubscriptionstatus_for_domain(){
    ...
    $client = new SoapClient(null, array(
    'location' => "http://www.wordpresscsvimporter.com/wordpresswebservices/wtgapi_webservice_checkdomainhassubscription.php.php",
    'uri'      => "http://www.wordpresscsvimporter.com/wordpresswebservices/request/"));
...
function wtgcsv_api_is_activationcodevalid_soapcall( $activationcode ){
    $client = new SoapClient(null, array(
    'location' => "http://www.wordpresscsvimporter.com/wordpresswebservices/wtgapi_pluginactivation_calls.php",
    'uri'      => "http://www.wordpresscsvimporter.com/wordpresswebservices/request/"));

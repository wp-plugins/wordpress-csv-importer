...
/**
* Updates default project value in giving project
* 
* @param mixed $wtgcsv_currentproject_code
* @param mixed $template_id
*/
function wtgcsv_update_defaulttemplate($project_code,$template_id){
    $project_array = wtgcsv_get_project_array($project_code);
    $project_array['default_contenttemplate_id'] = $template_id;

...
function wtgcsv_print_admin_scripts() {
    ...
    global $wtgcsv_js_switch;
     ...
     if($wtgcsv_js_switch == true){
        ...
        // use to switch between jquery package versions
        $script_version = '1.7.1';// 1.7.1
        
        // use min files or not
        $script_min = '';// add min too the value for including min scripts
        ...
        wp_deregister_script( 'jQuery-ui-core' );
            ...
            //wp_register_script( 'jquery-ui-core', 'http://jquery-ui.googlecode.com/svn/tags/latest/ui/jquery.ui.core.js');
            wp_register_script( 'jQuery-ui-core', WTG_CSV_URL.'templatesystem/script/jquery.ui.core.js');
        ...
        wp_deregister_script( 'jquery-ui-widget' );
            ...
            //wp_register_script( 'jquery-ui-widget', 'http://jqueryui.com/latest/ui/jquery.ui.widget.js');
            wp_register_script( 'jquery-ui-widget', WTG_CSV_URL.'templatesystem/script/jquery.ui.widget.js');
        ...
        wp_deregister_script( 'jquery-ui-accordion' );
            //wp_register_script( 'jquery-ui-accordion');
            //wp_register_script( 'jquery-ui-accordion', 'http://jqueryui.com/latest/ui/jquery.ui.accordion.js');
            wp_register_script( 'jquery-ui-accordion', WTG_CSV_URL.'templatesystem/script/jquery.ui.accordion.js');
        ...
        #                                      #
        ########################################
        wp_enqueue_script('jquery-ui-dialog');// in wordpress
        ...
        #                                      #
        ########################################        
        wp_enqueue_script('jquery-ui-selectable');// in wordpress  TODO: check if this is required, was selectable ever made use of ???
        ...
        // tabs navigation scroll buttons ### TODO:HIGHPRIORITY, do not think this file is in use please remove
        wp_register_script('jquery-scrollabletab',WTG_CSV_URL.'templatesystem/script/jquery.scrollabletab.js');
        wp_enqueue_script('jquery-scrollabletab');
                
        // file uploader @ http://pixelcone.com/fileuploader/demo/
        wp_register_script('jquery-fileuploader-pixelcone',WTG_CSV_URL.'templatesystem/script/jquery.fileUploader.js');
        wp_enqueue_script('jquery-fileuploader-pixelcone');
                   
        // data tables @ http://datatables.net/examples/
        wp_register_script('wtg-jquery-datatables',WTG_CSV_URL.'templatesystem/script/jquery.dataTables.js');
        wp_enqueue_script('wtg-jquery-datatables');       
...
function wtgcsv_php_version_check_wp_die(){
    if ( version_compare(PHP_VERSION, $wtgcsv_php_version_minimum, '<') ) {
        if ( is_admin() && (!defined('DOING_AJAX') || !DOING_AJAX) ) {
            ...
            on your hosting for security and reliability. You can get suitable hosting here at <a href="'.$wtgcsv_webtechglobalhostingurl.'">WebTechGlobal Hosting</a>.') );
        }
    }
}
...
*/
function wtgcsv_get_default_contenttemplate_id( $wtgcsv_currentproject_code ){

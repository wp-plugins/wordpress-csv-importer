...
if($cont){
    ...
    // Update the default template design for current project
    $cont = wtgcsv_form_change_default_template();
...
function wtgcsv_form_start_post_creation(){
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'creation' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'createpostsproject'){
         ...
         wtgcsv_create_posts($_POST['wtgcsv_project_code'],$_POST['wtgcsv_postsamount'],'manual','basic');
...
function wtgcsv_form_save_projectupdatesettings(){
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'postcontentupdatingsettings'){
        ...
        $updateproject_result = wtgcsv_update_option_postcreationproject($wtgcsv_currentproject_code,$project_array);
        if($updateproject_result){
            ...
            wtgcsv_notice('Could not update the project array stored in a Wordpress option record. It could be because no changes were made to the update settings form. Please check this, try again then seek support if you are not sure.','error','Large','Could Not Save Content Update Settings');
        }
...
function wtgcsv_form_save_categories_standard(){
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'standardcategories'){
        ...
        if( $_POST['wtgcsv_categorylevel4_select_columnandtable'] != 'notselected' && $_POST['wtgcsv_categorylevel3_select_columnandtable'] == 'notselected' ){
            $required_column_missing = true;
            $required_column_level = 3;
        }       
        
        // check if 5 is set - requires 4
        if( $_POST['wtgcsv_categorylevel5_select_columnandtable'] != 'notselected' && $_POST['wtgcsv_categorylevel4_select_columnandtable'] == 'notselected' ){
            $required_column_missing = true;
        ...
        if($required_column_missing){
            ...
            // add level 1 
            $project_array['categories']['standard']['level1']['table'] = wtgcsv_extract_value_from_string_between_two_values('#','@',$_POST['wtgcsv_categorylevel1_select_columnandtable']);
            $project_array['categories']['standard']['level1']['column'] = wtgcsv_extract_value_from_string_between_two_values('@','£',$_POST['wtgcsv_categorylevel1_select_columnandtable']);            

            // add level 2
            if($_POST['wtgcsv_categorylevel2_select_columnandtable'] != 'notselected'){
                $project_array['categories']['standard']['level2']['table'] = wtgcsv_extract_value_from_string_between_two_values('#','@',$_POST['wtgcsv_categorylevel2_select_columnandtable']);
                $project_array['categories']['standard']['level2']['column'] = wtgcsv_extract_value_from_string_between_two_values('@','£',$_POST['wtgcsv_categorylevel2_select_columnandtable']);                     
            }
            
            // add level 3
            if($_POST['wtgcsv_categorylevel3_select_columnandtable'] != 'notselected'){
                $project_array['categories']['standard']['level3']['table'] = wtgcsv_extract_value_from_string_between_two_values('#','@',$_POST['wtgcsv_categorylevel3_select_columnandtable']);
                $project_array['categories']['standard']['level3']['column'] = wtgcsv_extract_value_from_string_between_two_values('@','£',$_POST['wtgcsv_categorylevel3_select_columnandtable']);                     
            }                

            // add level 4
            if($_POST['wtgcsv_categorylevel4_select_columnandtable'] != 'notselected'){
                $project_array['categories']['standard']['level4']['table'] = wtgcsv_extract_value_from_string_between_two_values('#','@',$_POST['wtgcsv_categorylevel4_select_columnandtable']);
                $project_array['categories']['standard']['level4']['column'] = wtgcsv_extract_value_from_string_between_two_values('@','£',$_POST['wtgcsv_categorylevel4_select_columnandtable']);                     
            }
            
            // add level 5
            if($_POST['wtgcsv_categorylevel5_select_columnandtable'] != 'notselected'){
                $project_array['categories']['standard']['level5']['table'] = wtgcsv_extract_value_from_string_between_two_values('#','@',$_POST['wtgcsv_categorylevel5_select_columnandtable']);
                $project_array['categories']['standard']['level5']['column'] = wtgcsv_extract_value_from_string_between_two_values('@','£',$_POST['wtgcsv_categorylevel5_select_columnandtable']);                     
            }            
            ...
            if($updateproject_result){
                ...
                wtgcsv_notice('Could not update the project array stored in a Wordpress option record. It could be because no changes were made too the settings. Please check this, try again then seek support if you are not sure.','error','Large','Could Not Save Standard Category Settings');
            } 
        }
...
function wtgcsv_form_add_basic_custom_field(){
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'createbasiccustomfieldrules'){
        ...
        if(!isset($_POST['wtgcsv_key'])){
            ...
            $table_name = wtgcsv_extract_value_from_string_between_two_values('#','@',$_POST['multiselect_wtgcsv_customfield_select_columnandtable_formid']);
            $column_name = wtgcsv_extract_value_from_string_between_two_values('@','£',$_POST['multiselect_wtgcsv_customfield_select_columnandtable_formid']);            

            // get last array key for current custom fields if they exist
            if(isset($project_array['custom_fields']['basic'])){
                $last_array_key = wtgcsv_get_array_nextkey($project_array['custom_fields']['basic']);
            }else{
                $last_array_key = 0;
            }
            
            $project_array['custom_fields']['basic'][$last_array_key]['table_name'] = $table_name;
            $project_array['custom_fields']['basic'][$last_array_key]['column_name'] = $column_name;
            $project_array['custom_fields']['basic'][$last_array_key]['meta_key'] = $_POST['wtgcsv_key'];                        
            ...
            if($updateproject_result){
                ...
                wtgcsv_notice('No changes could be made at this time. Wordpress could not update the projects option record. Please try again then seek support.','error','Large','Could Not Save Rule');
            }
...
function wtgcsv_form_update_datecolumn(){
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'postdatescolumn'){
        ...
        // extract table name and column name from the string which holds both of them
        $table_name = wtgcsv_extract_value_from_string_between_two_values('#','@',$_POST['multiselect_wtgcsv_dynamicposttype_select_columnandtable_formid']);
        $column_name = wtgcsv_extract_value_from_string_between_two_values('@','£',$_POST['multiselect_wtgcsv_dynamicposttype_select_columnandtable_formid']);            

        // check if the submitted column is the same as already set - first check if the values have been set before
        if(isset($project_array['date_column']['table_name']) && isset($project_array['date_column']['column_name'])){
            if($project_array['date_column']['table_name'] == $table_name && $project_array['date_column']['column_name'] == $column_name){
        ...
        $project_array['date_column']['table_name'] = $table_name;            
        $project_array['date_column']['column_name'] = $column_name;
        ...
        if($updateproject_result){
            ...
            wtgcsv_notice('Your data column could not be saved. Please try again then seek support.','error','Large','Could Not Save Date Column');
        }
...
function wtgcsv_form_save_posttype_condition_byvalue(){
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'dynamicposttype'){
        ...
        if( !isset($_POST['wtgcsv_dynamicposttype_text_trigger']) ){
            ...
            $keyvalue = 0;
            if( isset($project_array['posttyperules']['byvalue']) && is_array($project_array['posttyperules']['byvalue']) ){
                $keyvalue = count($project_array['posttyperules']['byvalue']);    
            }
            ...
            $project_array['posttyperules']['byvalue'][$keyvalue]['table_name'] = $table_name;            
            $project_array['posttyperules']['byvalue'][$keyvalue]['column_name'] = $column_name;
            $project_array['posttyperules']['byvalue'][$keyvalue]['trigger_value'] = $_POST['wtgcsv_dynamicposttype_text_trigger'];            
            $project_array['posttyperules']['byvalue'][$keyvalue]['post_type'] = $_POST['wtgcsv_dynamicposttype_select_posttype'];
            ...
            if($updateproject_result){
                ...
                wtgcsv_notice('Post type rule could not be saved, it may be a duplicate. Please try again then seek support.','error','Large','Could Not Save Rule');
            }            
        }
...
function wtgcsv_form_insert_title_template(){
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'createtitletemplates'){
        ...
        if(wtgcsv_is_WP_Error($save_result)){
            ...
            wtgcsv_notice('Your new title template has been saved and can be used in any of your projects','success','Large','New Title Template Saved');
        }
...
*/
function wtgcsv_form_change_default_template(){
    global $wtgcsv_currentproject_code;
    if(isset($_POST['wtgcsv_change_default_template']) && isset($_POST['wtgcsv_templatename_and_id'])){
        ...
        if(!is_numeric($template_id)){
            wtgcsv_notice('The template ID could not be extracted from the submission, please try again then report this issue.','error','Large','Error Updating Default Template');
        }else{
            wtgcsv_update_defaulttemplate($wtgcsv_currentproject_code,$template_id);
            wtgcsv_notice('The template you selected has been saved as your current projects default template design.','success','Large','Default Template Saved');
        }
...
function wtgcsv_form_save_contenttemplatedesign_condition_byvalue(){
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'dynamiccontentdesignrulesbyvalue'){
        ...
        if( !isset($_POST['wtgcsv_dynamiccontentdesignrules_text_triggervalue']) ){
            ...
            // check if we already have template rules by value saved, count how many we have for applying array key value
            $keyvalue = 0;
            if( isset($project_array['templaterules']['byvalue']) && is_array($project_array['templaterules']['byvalue']) ){
                $keyvalue = count($project_array['templaterules']['byvalue']);    
            }
            
            // extract table name and column name from the string which holds both of them
            $table_name = wtgcsv_extract_value_from_string_between_two_values('#','@',$_POST['wtgcsv_dynamiccontentdesignrules_select_columnandtable']);
            $column_name = wtgcsv_extract_value_from_string_between_two_values('@','£',$_POST['wtgcsv_dynamiccontentdesignrules_select_columnandtable']);            

            $project_array['templaterules']['byvalue'][$keyvalue]['table_name'] = $table_name;            
            $project_array['templaterules']['byvalue'][$keyvalue]['column_name'] = $column_name;
            $project_array['templaterules']['byvalue'][$keyvalue]['trigger_value'] = $_POST['wtgcsv_dynamiccontentdesignrules_text_triggervalue'];            
            $project_array['templaterules']['byvalue'][$keyvalue]['template_id'] = $_POST['wtgcsv_dynamiccontentdesignrules_select_templateid'];
            ...
            if($updateproject_result){
                ...
                wtgcsv_notice('Template design rule could not be saved, the failure happened when trying to update the Wordress options table.','error','Large','Could Not Save New Template Design Rule');
            }            
        }
...
function wtgcsv_form_save_contenttemplate(){
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'templateeditor'){
        ...
        if($create_new_wtgcsvtemplate_post){   
            ...
            $wpinsertpost_result = wtgcsv_insert_post_contenttemplate();
            ...
            if(wtgcsv_is_WP_Error($wpinsertpost_result)){
                ...
                wtgcsv_notice('Your new template has been saved. You can select it in your projects settings and edit it using the same editor as you created it with.','success','Large','New Template Saved');
            }            
        }
...
function wtgcsv_form_change_current_project(){
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'selectcurrentproject'){
        if( $_POST['wtgcsv_radio_projectcode'] == $wtgcsv_currentproject_code){
            ...
            $changecurentproject_result = wtgcsv_update_currentproject($_POST['wtgcsv_radio_projectcode']);
            if($changecurentproject_result){
                ...
                wtgcsv_notice('No changes were made and you are still working on the same project as you were already. This happened because Wordpress could not save the change in the options table. Please try again then seek support.','error','Large','Changes Could Not Be Made');
            }    
        }
        return false;
    }else{
    ...
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'deleteprojects'){
        if(!isset($_POST['wtgcsv_projectcodes_array'])){
            ...
            foreach($_POST['wtgcsv_projectcodes_array'] as $key => $project_code){
                $deleteproject_result = wtgcsv_delete_postcreationproject($project_code);
                if($deleteproject_result){
                    wtgcsv_notice('Your project with code '.$project_code.' has been deleted.','success','Large','Project '.$project_code.' Deleted');    
                }else{
                    wtgcsv_notice('Your project with code '.$project_code.' could not be deleted.','error','Large','Project '.$project_code.' Not Deleted');
                }
            }
        }
        return false;
...
function wtgcsv_form_create_post_creation_project(){
    if(isset( $_POST['wtgcsv_hidden_pageid'] ) && $_POST['wtgcsv_hidden_pageid'] == 'projects' && isset($_POST['wtgcsv_hidden_panel_name']) && $_POST['wtgcsv_hidden_panel_name'] == 'createpostcreationproject'){
        if(!isset($_POST['wtgcsv_databasetables_array'])){
            ...
            $createproject_result_code = wtgcsv_create_post_creation_project($_POST['wtgcsv_projectname_name'],$_POST['wtgcsv_databasetables_array'],$_POST['wtgcsv_projecttables_mappingmethod_inputname']);
...
function wtgcsv_form_tabdisplay(){
    if(isset($_POST[WTG_CSV_ABB.'hidden_pageid']) && $_POST[WTG_CSV_ABB.'hidden_pageid'] == 'settings' && isset($_POST[WTG_CSV_ABB.'hidden_panel_name']) && $_POST[WTG_CSV_ABB.'hidden_panel_name'] == 'tabsdisplay'){
        ...
        if($update_tabmenu_result){
         ...
         wtgcsv_notice('The plugin did not detect any changes to tab settings.','info','Extra','');

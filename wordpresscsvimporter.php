...
Description: Wordpress CSV Importer released 2012
Author: Zara Walsh
Author URI: http://www.wordpresscsvimporter.com
*/

/*********************************************************************************************************************************
* ALPHA PHASE DEVELOPMENT NOTES
* 0. Add variable for switching all API off before BETA release
* 1. Create help notices for each page that user needs to delete once   
*******************************************************************************************************************************/
...
$wtgcsv_edition = 1;// 0 = free, 1 = premium, 3 = customised (this is only used for controlling the interface not access to services or abilities)
$wtgcsv_currentversion = '0.0.1';
$wtgcsv_php_version_tested = '5.3.1';// current version the plugin is being developed on
$wtgcsv_php_version_minimum = '5.2.0';// minimum version required for plugin to operate
// plugin build
...
if(is_admin()){ 
    ...
    ####                                                                   ####
    ###########################################################################
    add_action('admin_menu','wtgcsv_admin_menu'); 
